...
const UploadPoemPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await apiClient.createPoem(data);
      setSuccess(true);
      setFormData({
        titleBengali: '',
        titleEnglish: '',
      ...
      setError(err.response?.data?.error || 'Failed to upload poem');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <>
      <Head>
        <title>কবিতা যোগ করুন | Bangla Kobita Admin</title>
      </Head>
      ...
      <AdminLayout onLogout={handleLogout}>
        <div className="p-8 max-w-4xl mx-auto">
          ...
          <p className="text-gray-600 dark:text-gray-400 bengali-text mb-8">
            আপনার কবিতা আপলোড করুন এবং পাঠকদের সাথে ভাগ করুন
          </p>

          {success && (
            <div className="mb-6 p-4 bg-green-100 text-green-700 rounded-lg">
              কবিতা সফলভাবে আপলোড হয়েছে! ড্যাশবোর্ডে ফিরছি...
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 rounded-lg p-8 shadow">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <input
                type="text"
                name="titleBengali"
                placeholder="কবিতার শিরোনাম (বাংলা)"
              ...
              <input
                type="text"
                name="titleEnglish"
                placeholder="Poem Title (English)"
            ...
            >
              {loading ? 'আপলোড হচ্ছে...' : 'কবিতা যোগ করুন'}
            </button>
          </form>
        </div>
      </AdminLayout>
